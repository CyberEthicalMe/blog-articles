---
title: "How to install Kali on the Virtual Machine"
seoDescription: "Step-by-step guide on installing and configuring Kali Linux on the VirtualBox."
datePublished: Mon Aug 30 2021 00:17:46 GMT+0000 (Coordinated Universal Time)
cuid: cksxw7g960xc9n1s1gabj3y1w
slug: how-to-install-kali-on-the-virtual-machine
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1630257568563/R7E5Mzlhy.png
ogImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1630258602857/dJUA9V_DB.png
tags: linux, learning, guide, cybersecurity-1
...
![2021-08-29-10-30-03.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257642470/LmuZPPQF6.png align="left")

This way, we will be proceeding as if we have an installer disk and a clean workstation without OS installed.

## Validate checksum

![kali-bare-sum.gif](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257652432/hDN8N0-p3.gif align="left")
...
On the main window, click *New*.

> If you don't see this button, you can also choose *Machine* -&gt; *New* from the menu.

![2021-08-29-10-26-28.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257662147/I_ebfu1KU.png align="left")
...
![2021-08-29-10-43-56.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257671322/zGkvYnoV7.png align="left")
...
![2021-08-29-10-56-09.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257680701/LsMehsISu.png align="left")

![2021-08-29-10-56-24.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257686566/r-QS-s8zd.png align="left")

You can choose the disk file by yourself - I tend to use `VDI` for no specific reason.

![2021-08-29-10-56-40.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257696097/dkwTuqRvr.png align="left")
...
![2021-08-29-11-04-02.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257701588/AFLtTqpwH.png align="left")
...
> If you don't want to resize the disk later, choose 50GB or 100GB (even better, and optimal in 2023).

![2021-08-29-11-07-47.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257712192/a2X30LmWO.png align="left")

Now VirtualBox is preparing everything, and we have our machine visible on the list of available boxes.

![2021-08-29-11-09-16.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257723082/CCq52d7MIw.png align="left")

You can ask a question: "we have chosen the RAM, the disk - what about CPU cores?". And it is a good question. Virtual machines tend to be flexible, so at any time, the machine is not powered on, you can specify these parameters in the machine settings. Go to *Settings* → *System* and select **at least 2 cores** - I find that my setup works better at 4 cores.

![2021-08-29-11-11-34.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257735424/NraLCR216.png align="left")
...
![2021-08-29-11-26-01.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257742051/E2UAWy0IR.png align="left")

Select the downloaded Kali image installation media by going to *Settings* → *Storage*, and mount the `*.iso` in the empty IDE device.

![2021-08-29-11-28-53.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257753046/j1x3OHVbh.png align="left")

Now when you launch the machine you will see the installation menu.

![2021-08-29-11-30-53.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257760911/esfn8fDHI.png align="left")
...
![kali-bare-install.gif](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257779274/Z9lXcS5SW.gif align="left")

%%[join-cta] 

## Choose partitioning method

This is a frequent topic of discussions - *should I use LVM or not*. Simple answer - yes, you want. Longer and more correct answer - **it depends**. A significant advantage of LVM is ease of repartitioning with minimal (but still significant on heavily exploited system) overhead.
...
![2021-08-29-13-07-29.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257788392/TgIO_LjAV.png align="left")
...
![2021-08-29-14-00-30.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257798893/ZspQf5aWy.png align="left")
...
![2021-08-29-14-26-12.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257806857/QXatXk5gx.png align="left")

I am using the whole available space

![2021-08-29-14-32-05.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257812519/eb2n4QCFJ.png align="left")

And finally leave *Finish partitioning* to write changes to disk.

![2021-08-29-14-33-31.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257824004/ttMre-3I1.png align="left")

## Additional software

![2021-08-29-14-46-46.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257818359/TsaWfxfu4.png align="left")

I'm a fan of installing only software I need, but here to save time, I can consider choosing `large`.

> During the installation this time I've got the error on this step. Tried to fix that, but finally I've chosen the *Abort installation* option and tried without choosing the `large` tools pack. Please let me know in the comments if it was the same case for you.

Follow screenshots to finish installation.

![2021-08-29-16-05-25.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257836226/dBc_-_N_N.png align="left")

![2021-08-29-16-08-58.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257842828/CjmMPT-AX.png align="left")

![2021-08-29-16-11-28.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257848218/wg54cwAid.png align="left")

# Last steps

![2021-08-29-16-12-57.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257853423/9dikQNRTA.png align="left")
...
![2021-08-29-16-17-39.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257866969/qCfixv-ad.png align="left")
...
![2021-08-29-16-31-28.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257874423/epLl-8ULS.png align="left")
...
![2021-08-29-16-40-55.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1630257879448/huB5ubOHP.png align="left")
